  ...
  return (
    <View style={style.container}>
      ...
      <View style={{margin: 20, paddingTop: 30}}>
        <Text style={{fontSize: 24, color: 'black', fontWeight: 'bold', textAlign: 'center'}}>Easy</Text>
        <Text style={{textAlign: 'center', fontSize: 16, color: 'black', marginHorizontal: 30, marginVertical: 30}}>Just scan the QR code to sign in to our parking service</Text>
      </View>
      <View style={{display: 'flex', flexDirection: 'row', justifyContent: 'space-between', paddingTop: 120, paddingRight: 20, paddingLeft: 20}}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('SplashFast')}
